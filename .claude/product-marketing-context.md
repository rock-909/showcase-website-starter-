...
| 新项目团队 | 是否能快速换品牌上线 | 内容和配置散落难替换 | `docs/website/` 和 `src/config/website/` 提供替换面 |
...
4. **Replaceable business surface**：品牌和内容替换面集中在 `docs/website/`、`src/config/website/`、`content/`、`messages/`。
