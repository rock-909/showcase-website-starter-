...
Desktop: Navigation bar shows links to Home, Products, Custom, About, and Contact. Mobile: Hamburger menu opens a sheet with the same links. Clicking any link reaches the correct page. Blog links are intentionally absent while BC-015 and BC-016 remain retired.
