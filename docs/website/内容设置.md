...
The old top-level files `src/lib/content-manifest.generated.ts` and
`src/lib/mdx-importers.generated.ts` are compatibility facades only. They are
not generator outputs after the content family migration.
